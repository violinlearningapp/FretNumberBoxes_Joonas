...
public class MIDIPlayer : MonoBehaviour
{
    ...
    public string midiFilePath = "Midis/Carnival.mid";
...
void Awake()
    ...
    public void Pause()
    {
        if (midiSequencer.isPlaying == true)
        {
            // midiSequencer.Stop(true);
            Debug.Log("Time: " + midiSequencer.Time.Seconds.ToString());
            Debug.Log("Sample time: " + midiSequencer.SampleTime.ToString());
            Debug.Log("End time: " + midiSequencer.EndTime);
            // Debug.Log("channel: " + channel + " " + midiSequencer.getProgramName(channel));
            // channel++;
